...
class FactsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('school.admin.facts.index', compact('facts'));
    }
    ...
    public function create()
    {
        ...
        return view('school.admin.facts.create', compact('files'));
        //
    }
    ...
    public function show($id)
    {
        ...
        return view('school.admin.facts.show', compact('facts'), compact('files'));
    }
    ...
    public function edit($id)
    {
        ...
        $facts = new Facts;
        $facts = $facts->where('id', $id)->First();
        return view('school.admin.facts.edit', compact('facts'), compact('files'));
    }
